...
{
    public class KSFilterUTF8 : KSFilter
    {
        public KSFilterUTF8(byte[] Script) : base(Script)
        {
			Eco = Encoding.UTF8;
        }
    }

	public class KSFilterUTF16 : KSFilter
	{
		public KSFilterUTF16(byte[] Script) : base(Script)
		{
			Eco = Encoding.Unicode;
		}
	}

	public class KSFilter : PluginBase {
		/*
		...
		*/
        ...
        protected Encoding Eco = Encoding.GetEncoding(932);
        protected Encoding Eco2 = Encoding.Unicode;
